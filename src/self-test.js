...
function updateSelfTest(delta) {
  ...
  // Normal support pressure may reduce travel, but a full geometry-driven body
  // stop should now be exceptional and too short to read as a visible pause.
