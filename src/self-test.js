...
function updateSelfTest(delta) {
  ...
  const passed = complete && testRun.timeouts === 0 && testRun.steps >= 8 && testRun.maxReach <= 58.1 && testRun.maxSector <= .9 && testRun.minFootGap >= 10 && testRun.maxLegCrossings === 0 && testRun.maxCoxaShellError < .001 && testRun.bodyPenetrations === 0 && testRun.maxTurn >= testRun.minTurn && angleEnvelopePass && frontPass;
